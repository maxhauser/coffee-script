(function() {
  ...
  exports.Rewriter = (function() {
    ...
    Rewriter.prototype.rewrite = function(tokens) {
      ...
      this.transformContinuations();
      return this.tokens;
    };
    Rewriter.prototype.rewriteContinuations = function() {
    ...
    Rewriter.prototype.transformContinuations = function() {
      var continuations, indentlevel;
      continuations = [];
      indentlevel = 0;
      this.scanTokens(function(token, i, tokens) {
        ...
        if (tag === '=>' && token[3] === true) {
          continuations.push({
            level: indentlevel,
            tokens: tokens.splice(i + 2, 3)
          });
        }
        if (tag === 'OUTDENT' && continuations.length > 0 && continuations[continuations.length - 1].level === indentlevel) {
          p = [i, 0];
      ...
      return continuations.forEach(__bind(function(cont) {
        return Array.prototype.push.apply(this.tokens, cont.tokens);
      }, this));
    };
